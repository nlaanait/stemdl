...
if __name__ == '__main__':
    io_utils.write_json_network_config('network_regressor_VGG.json', layer_keys_list, layer_params_list)
    _ = io_utils.load_json_network_config('network_regressor_VGG.json')
    io_utils.write_json_hyper_params('hyper_params_regressor_VGG.json', hyper_params_regression)
    _ = io_utils.load_json_hyper_params('hyper_params_regressor_VGG.json')
